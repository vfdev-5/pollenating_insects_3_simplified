...
class ImageClassifier(object):
    ...
    def fit(self, img_loader):
        ...
        train_gen_builder = BatchGeneratorBuilder(img_loader,
                                                  ...
                                                  chunk_size=batch_size * 5, n_jobs=5)
    ...
    def _build_model(self):
        vgg = VGG16(input_shape=SIZE + (3,), include_top=False, weights='imagenet')
        x = vgg.get_layer(name='block3_pool').output
        # x = vgg.outputs[0]
        # Classification block
        x = MaxPool2D((9, 9), strides=(9, 9))(x)
